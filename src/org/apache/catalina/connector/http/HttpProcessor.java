...
final class HttpProcessor
    ...
    /**
     * Is there a new socket available?（是否有一个新的socke 可用）
     */
    ...
    /**
     * Process an incoming（进来的） HTTP request on the Socket that has been assigned
    ...
    public void run() {
        ...
        while (!stopped) {
            ...
            // Finish up this request。讲对象重新放入stack中
